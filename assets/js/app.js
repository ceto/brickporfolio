...
var $homecarousel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.homecarousel');
var $navcarousel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navcarousel');
...
document.addEventListener("DOMMouseScroll", detectTrackPad, false); // Pause all videos
// document.querySelectorAll('video').forEach(vid => vid.pause());
//Mobile videos autostart/pause

jquery__WEBPACK_IMPORTED_MODULE_0___default()('video').bind('inview', function (event, visible, topOrBottomOrBoth) {
  if (visible == true) {
    this.play();
  } else {
    this.pause();
...
$homecarousel.on("init", function (event, slick) {
  ...
  var elSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()(slick.$slides[slick.slickGetOption('initialSlide')]);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').html(jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('figure').attr('data-title') + '<em>' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('figure').attr('data-description') + '</em>'); // if ($(elSlide).find('video').length) {
  //     $(elSlide).find('video').get(0).play();
  // }
}).on('beforeChange', function (event, slick, currentSlide, nextSlide) {
  slickIsChanging = true; // // Pause all videos
  // document.querySelectorAll('video').forEach(vid => vid.pause());

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').addClass('willchange');
}).on('afterChange', function (event, slick, currentSlide) {
  slickIsChanging = false;
  var elSlide = jquery__WEBPACK_IMPORTED_MODULE_0___default()(slick.$slides[currentSlide]);
  var matrix = jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).closest('.slick-track').css('transform').replace(/[^0-9\-.,]/g, '').split(',');
  var x = parseInt(matrix[12] || matrix[4]); // if ($(elSlide).find('video').length) {
  //     $(elSlide).find('video').get(0).play();
  // }

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('figure[data-title]').length) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').html(jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('figure').attr('data-title') + '<em>' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('figure').attr('data-description') + '</em>');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').html('&nbsp;');
  } // console.log($(elSlide).find('.citem').innerWidth() + '-' + containerWidth);


  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('.citem').hasClass('is-open')) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('.citem').innerWidth() > containerWidth) {
      var igazIt = parseInt(ipanelPad + jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).find('.citem').offset().left - bigLeft);
      setTimeout(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(elSlide).closest('.slick-track').css('transform', 'translate3d(' + parseInt(x - igazIt) + 'px, 0px, 0px)');
      }, 0);
    }
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').removeClass('willchange');
  }
}).slick({
  arrows: false,
  infinite: false,
...
$navcarousel.slick({
  ...
  cssEase: 'ease-out' // easing: 'ease-out'

});

function mouseWheel($homecarousel) {
  $homecarousel.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", {
...
function mouseWheelHandler(event) {
  ...
  var $slideContainer = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  ...
  if ($slideContainer.find('.slick-current').find('.citem.is-open').length > 0) {
    ...
    if (!$slideContainer.hasClass('scrolling') && slickIsChanging == false) {
      ...
      if (delta > 0) {
        ...
        if ($homecarousel.slick('slickCurrentSlide') > 0) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-arrow').on('click', function (e) {
  var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  e.preventDefault();
  var $slideContainer = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.homecarousel');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').on('click', function (e) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').toggleClass('willchange');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-current .citem').toggleClass('is-open');
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.citem figure').on('click', 'a', function (e) {
  var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slick-slide').hasClass('slick-current') && jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.citem').find('.ipanel').length) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.citem').hasClass('is-open')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.citem').removeClass('is-open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').removeClass('willchange');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.citem').addClass('is-open');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carouselstatus').addClass('willchange');
    }
  }

  if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slick-slide').hasClass('slick-current')) {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-current').find('.citem.is-open').length > 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-current').find('.citem').removeClass('is-open');
    } else {
      var activeseslide = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slick-current').attr('data-slick-index');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slidecard figure').on('click', 'a', function (e) {
  e.preventDefault();

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slidecard').find('.ipanel').length) {
    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slidecard').hasClass('is-open')) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slidecard').addClass('is-open');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).closest('.slidecard').removeClass('is-open');
    }
  }
...
module.exports = __webpack_require__(/*! /Users/ceto/Htdocs/apps/brickporfolio/src/assets/js/app.js */"./src/assets/js/app.js");
